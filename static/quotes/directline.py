          ...
          if age <= 3:
            if ins_type == "psv": 
              if sum_assured >= 110000:
                ...
                return round(premium + excess_protector), "Ksh {:6,.0f} per year Including excess protector and 100k PA".format(premium + excess_protector) 
            ...
            if sum_assured >= 750000:
                if age <= 15:
                    if usage in ["own_goods", "general_cartage"] and body_type not in ["motor_cycle", "tuktuk", "primemover"]:
                        ...
                        return round(premium + excess_protector), "Ksh {:6,.0f} per year Including excess protector and PLL".format(premium + excess_protector)
