    ...
    if ins_type == "private" and body_type in ["personalcar", "pickup"] and usage == "private":
      ...
      if age <= 15:
        if sum_assured < 1000000:
          ...
          return round(premium + excess_protector), "Ksh {:6,.0f} per year Including excess protector and PVT".format(premium + excess_protector)
        ...
        if sum_assured < 1000000:
          ...
          return round(premium + excess_protector), "Ksh {:6,.0f} per year Excluding excess protector and PVT".format(premium + excess_protector)
      ...
      if ins_type == "psv": 
        ...
        return round(premium + excess_protector), "Ksh {:6,.0f} per year Excluding excess protector (Includes PLL. Max 3passengers)".format(premium + excess_protector)
      else:
        premium = max(7500, 0.03 * sum_assured) * mark_up  
        return round(premium + excess_protector), "Ksh {:6,.0f} per year Excluding excess protector ".format(premium + excess_protector)
      ...
      if age <= 15:
        if sum_assured < 1000000:
          ...
          return round(premium + excess_protector), "Ksh {:6,.0f} per year Including excess protector, PVT and PLL ".format(premium + excess_protector)
      ...
      if sum_assured < 1000000:
        ...
        return round(premium + excess_protector), "Ksh {:6,.0f} per year Excluding excess protector (Includes PLL)".format(premium + excess_protector)
      ...
      return round(premium + excess_protector), "Ksh {:6,.0f} per year Excluding excess protector (Includes PLL. Max 7 Passengers)".format(premium + excess_protector)
...
def tpo_cover(duration, ins_type, owner_type, body_type, usage, tonnage, seat_cap):
    ...
    if duration == "annual":
        if ins_type == "private" and body_type in ["personalcar", "pickup"] and usage == "private":
          ...
          return round(premium), "Ksh {:6,.0f} per year Including PLL".format(premium)
          ...
          if ins_type == "psv": 
            ...
            return round(premium), "Ksh {:6,.0f} per year Including PLL (3 Passengers max)".format(premium)
          else:
            premium = 3000
            return round(premium *mark_up), "Ksh {:6,.0f} per year".format(premium *mark_up)
          ...
          return round(premium), "Ksh {:6,.0f} per year Including PLL (7 Passengers max)".format(premium)
    ...
    #TOR premium computations        
        ...
        if ins_type == "private" and body_type in ["personalcar", "pickup"]:
          ...
          return round(premium), "Ksh {:6,.0f} for the month".format(premium)
          ...
          if tonnage <= 3:
              ...
              premium = 5500
              return round(premium *mark_up), "Ksh {:6,.0f} for the month".format(premium *mark_up)
          ...
          if ins_type == "psv": 
            pll = 750
            premium = 1800 * mark_up
            return round(premium), "Ksh {:6,.0f} for the month (3 Passengers max)".format(premium)
          else:
              premium = 1500
              return round(premium *mark_up), "Ksh {:6,.0f} for the month".format(premium *mark_up)
